...
import openlib.animation.BitmapSymbol;
...
class Library
{
    ...
    public function new (baseDir :String)
    {
        ...
        var json :Format = Json.parse(Assets.getText(baseDir + "/library.json"));
        ...
        for (atlasObject in atlases) {
            var atlas = Assets.getBitmapData(baseDir + "/" + atlasObject.file);
