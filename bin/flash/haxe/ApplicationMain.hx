...
class ApplicationMain {
	...
	public static function main() {
		...
		//nme.Lib.setPackage("Lino", "OpenFL", "OpenFL", "1.0.0");
	...
	private static function begin() {
		...
		for (methodName in Type.getClassFields(OpenFLMain))
		{
			if (methodName == "main")
			{
				hasMain = true;
		...
		if (hasMain)
		{
			Reflect.callMethod(OpenFLMain, Reflect.field (OpenFLMain, "main"), []);
		}
		else
		{
...
class DocumentClass extends OpenFLMain { }
